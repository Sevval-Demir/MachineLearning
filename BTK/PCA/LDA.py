# -*- coding: utf-8 -*-
"""
Created on Tue Aug  5 23:50:01 2025
...
X_train_lda=lda.fit_transform(X_train,y_train) #lda çalışabilmesi için sınıfları öğrenmesi gerekiyor
#lda sınıfların boyutunu alıyor
X_test_lda = lda.transform(X_test)

#lda dönüşümünden sonra gelen 
...
from sklearn.metrics import confusion_matrix
#LDA sonrası / LDA öncesi
print('LDA VE ORİJİNAL')
